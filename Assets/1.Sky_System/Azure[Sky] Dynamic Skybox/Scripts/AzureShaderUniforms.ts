namespace UnityEngine.AzureSky
{
    internal static class AzureShaderUniforms
    {
        ...
        internal static readonly int StarFieldRotationMatrix = Shader.PropertyToID("_Azure_StarFieldRotationMatrix");
        ...
        internal static readonly int SkyScale = Shader.PropertyToID("_Azure_SkyScale");
        ...
        // Static clouds
        internal static readonly int StaticCloudLayer1Rotation = Shader.PropertyToID("_Azure_StaticCloudLayer1Rotation");
        internal static readonly int StaticCloudLayer2Rotation = Shader.PropertyToID("_Azure_StaticCloudLayer2Rotation");
