...
Shader "SyntyStudios/VegitationShader"
{
	Properties
	{
		...
		SubShader
		{
			...
			// Support for INSTANCED INDIRECT!!
		...
		void surf(Input i, inout SurfaceOutputStandard o)
		{
			...
			float4 Albedo78 = (i.vertexColor.b > 0.5 ? lerpResult605 : lerpResult603);
			...
			float mulTime436 = _Time.y * _PulseSpeed;
			...
			Pass
		{
			...
			v2f vert(appdata_full v)
			{
				...
				// Adjust for custom input data (if needed)
				Input customInputData;
				vertexDataFunc(v, customInputData);

				// Calculate world space values
				...
				// Pack tangent space and custom data
				o.tSpace0 = float4(worldTangent.x, worldBinormal.x, worldNormal.x, worldPos.x);
				o.tSpace1 = float4(worldTangent.y, worldBinormal.y, worldNormal.y, worldPos.y);
				o.tSpace2 = float4(worldTangent.z, worldBinormal.z, worldNormal.z, worldPos.z);
				o.customPack1.xy = customInputData.uv_texcoord; // Adjust based on your custom input
				o.color = v.color;
			...
			// Alpha clipping based on the _Cutoff value
			clip(IN.color.a - _Cutoff);

			// Perform shadow caster fragment operation
...
/*ASEBEGIN
Version=18909
-3429;13;2956;1357;4614.783;-1416.949;1;True;True
...
Node;AmplifyShaderEditor.TexturePropertyNode;587;-2888.277,-1328.446;Inherit;True;Property;_Vert1;Vert;53;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;589;-2883.199,-1833.299;Inherit;True;Property;_Albedo1;Albedo;52;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;433;-2998.298,1902.813;Inherit;True;Property;_EmissivePulseMap;EmissivePulseMap;29;0;Create;True;0;0;0;False;0;False;-1;bdbe94d7623ec3940947b62544306f1c;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;591;-2888.276,-1585.007;Inherit;True;Property;_Normal1;Normal;51;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;41.30931,209.989;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;SyntyStudios/VegitationShader;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.4;True;True;0;True;TransparentCutout;;Geometry;All;16;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=DCAD500997E22D38A3F8174830B16401055EF9F6